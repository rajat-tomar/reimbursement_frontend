...
import {Login} from "../../../../Library/Application Support/JetBrains/WebStorm2022.1/scratches/Login";
        ...
        <nav className="bg-gray-800">
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div
                        className= {"absolute inset-y-0 right-0 flex items-center pr-4 sm:static sm:inset-auto sm:ml-6 sm:pr-0"}>
                        <Login/>
                    </div>
